        ...
        {confirmConvert ? (
          <div className="mt-4 rounded-xl border border-gold/20 bg-gold-soft p-4">
            <p className="text-xs text-muted">
              Converting switches this workspace to the Institutional dashboard (subscription-based). Your treasury data
              stays in the database, but metered chat + token tools are replaced by manual spend tracking. You can
              switch back anytime.
            </p>
            <div className="mt-3 flex items-center gap-2">
              ...
              >
                {converting ? "Converting…" : "Confirm — convert to Institutional"}
              </button>
              <button
          ...
          >
            Convert to Institutional workspace
          </button>
        )}
      </section>
